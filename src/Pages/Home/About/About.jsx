    ...
    <div className="hero my-10 min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row">
        <div className="lg:w-1/2 relative">
          ...
          <img
            src={parts}
            className="rounded-lg absolute w-1/2 border-8 border-white right-10 top-1/2"
          />
        </div>
        <div className="lg:w-1/2 space-y-5">
          ...
          <button className="btn btn-error text-white bg-orange-600 font-bold">Get More Info</button>
        </div>
      </div>
    </div>
  );
